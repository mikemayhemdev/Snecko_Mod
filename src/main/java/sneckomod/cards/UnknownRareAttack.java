 ...
 public class UnknownRareAttack
   extends AbstractSneckoCard
 {
   ...
   {
     super("Snecko:UnknownRareAttack", NAME, SneckoMod.getResourcePath("cards/unknownUA.png"), 0, DESCRIPTION, TYPE, AbstractCardEnum.SNECKO, RARITY, TARGET);
   ...
   private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Snecko:UnknownRareAttack");
   public static final String NAME = cardStrings.NAME;
   public static final String DESCRIPTION = cardStrings.DESCRIPTION;
   public static String UPGRADED_DESCRIPTION = cardStrings.UPGRADE_DESCRIPTION;
   public static final String ID = "Snecko:UnknownRareAttack";
   public static final String IMG_PATH = "cards/unknownRA.png";
