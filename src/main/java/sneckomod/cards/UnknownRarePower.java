   ...
   extends AbstractSneckoCard
 {
   ...
   {
     super("Snecko:UnknownRarePower", NAME, SneckoMod.getResourcePath("cards/unknownRP.png"), 0, DESCRIPTION, TYPE, AbstractCardEnum.SNECKO, RARITY, TARGET);
   ...
   private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Snecko:UnknownRarePower");
   public static final String NAME = cardStrings.NAME;
   public static final String DESCRIPTION = cardStrings.DESCRIPTION;
   public static String UPGRADED_DESCRIPTION = cardStrings.UPGRADE_DESCRIPTION;
   public static final String ID = "Snecko:UnknownRarePower";
   public static final String IMG_PATH = "cards/unknownRP.png";
