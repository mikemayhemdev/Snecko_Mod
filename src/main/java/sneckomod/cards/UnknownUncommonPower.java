 ...
 public class UnknownUncommonPower
   extends AbstractSneckoCard
 {
   ...
   {
     super("Snecko:UnknownUncommonPower", NAME, SneckoMod.getResourcePath("cards/unknownRP.png"), 0, DESCRIPTION, TYPE, AbstractCardEnum.SNECKO, RARITY, TARGET);
   ...
   public AbstractCard makeCopy() {
     return new UnknownUncommonPower();
   }
   ...
   private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Snecko:UnknownUncommonPower");
   public static final String NAME = cardStrings.NAME;
   public static final String DESCRIPTION = cardStrings.DESCRIPTION;
   public static String UPGRADED_DESCRIPTION = cardStrings.UPGRADE_DESCRIPTION;
   public static final String ID = "Snecko:UnknownUncommonPower";
   public static final String IMG_PATH = "cards/unknownUP.png";
